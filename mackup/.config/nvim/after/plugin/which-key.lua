...
wk.register({
    -- Harpoon
    ["'"] = { "<cmd>nnoremap <silent><leader>' :lua require('harpoon.mark').add_file()<cr>", "Add to Harpoon" },
    ["0"] = { "<cmd>nnoremap <silent><leader>0 :lua require('harpoon.ui').toggle_quick_menu()<cr>", "Show Harpoon" },
    ["1"] = { "<cmd>nnoremap <silent><leader>1 :lua require('harpoon.ui').nav_file(1)<cr>", "Harpoon Buffer 1" },
    ["2"] = { "<cmd>nnoremap <silent><leader>2 :lua require('harpoon.ui').nav_file(2)<cr>", "Harpoon Buffer 2" },
    ["3"] = { "<cmd>nnoremap <silent><leader>3 :lua require('harpoon.ui').nav_file(3)<cr>", "Harpoon Buffer 3" },
    ["4"] = { "<cmd>nnoremap <silent><leader>4 :lua require('harpoon.ui').nav_file(4)<cr>", "Harpoon Buffer 4" },
    ["5"] = { "<cmd>nnoremap <silent><leader>5 :lua require('harpoon.ui').nav_file(5)<cr>", "Harpoon Buffer 5" },
    ["6"] = { "<cmd>nnoremap <silent><leader>6 :lua require('harpoon.ui').nav_file(6)<cr>", "Harpoon Buffer 6" },
    ["7"] = { "<cmd>nnoremap <silent><leader>7 :lua require('harpoon.ui').nav_file(7)<cr>", "Harpoon Buffer 7" },
