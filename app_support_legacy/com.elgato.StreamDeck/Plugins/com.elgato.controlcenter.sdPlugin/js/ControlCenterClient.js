...
// collect device types (used as fallback for device detection)
DEVICETYPES.ALL =  Object.values(DEVICETYPES); // all  
DEVICETYPES.KEYLIGHTS = [DEVICETYPES.KEYLIGHT, DEVICETYPES.KEYLIGHTMK2, DEVICETYPES.KEYLIGHTAIR, DEVICETYPES.RINGLIGHT, DEVICETYPES.KEYLIGHTMINI];
